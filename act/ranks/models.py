...
class ACT(models.Model):
    ...
    t1player1 = models.CharField(max_length=50, null=True)
    t1player2 = models.CharField(max_length=50, null=True)
    t2player1 = models.CharField(max_length=50, null=True)
    t2player2 = models.CharField(max_length=50, null=True)
    t3player1 = models.CharField(max_length=50, null=True)
    t3player2 = models.CharField(max_length=50, null=True)
    t4player1 = models.CharField(max_length=50, null=True)
    t4player2 = models.CharField(max_length=50, null=True)
    CHARACTER_CHOICES = (
        ("B", "B"),
        ("T", "T"),
        ("K", "K"),
...
class GlobalVariables(models.Model):
    score_sd = models.FloatField(default=0, null=False)
    toad_bowser = models.FloatField(default=0, null=False)
    toad_bowser_count = models.IntegerField(default=0, null=False)
    toad_diddy = models.FloatField(default=0, null=False)
    toad_diddy_count = models.IntegerField(default=0, null=False)
    toad_koopa = models.FloatField(default=0, null=False)
    toad_koopa_count = models.IntegerField(default=0, null=False)
    toad_baby = models.FloatField(default=0, null=False)
    toad_baby_count = models.IntegerField(default=0, null=False)
    bowser_diddy = models.FloatField(default=0, null=False)
    bowser_diddy_count = models.IntegerField(default=0, null=False)
    bowser_koopa = models.FloatField(default=0, null=False)
    bowser_koopa_count = models.IntegerField(default=0, null=False)
    bowser_baby = models.FloatField(default=0, null=False)
    bowser_baby_count = models.IntegerField(default=0, null=False)
    diddy_koopa = models.FloatField(default=0, null=False)
    diddy_koopa_count = models.IntegerField(default=0, null=False)
    diddy_baby = models.FloatField(default=0, null=False)
    diddy_baby_count = models.IntegerField(default=0, null=False)
    koopa_baby = models.FloatField(default=0, null=False)
    koopa_baby_count = models.IntegerField(default=0, null=False)
    koopa_koopa = models.FloatField(default=0, null=False)
    koopa_koopa_count = models.IntegerField(default=0, null=False)
    baby_baby = models.FloatField(default=0, null=False)
    baby_baby_count = models.IntegerField(default=0, null=False)
    others = models.FloatField(default=0, null=False)
    others_count = models.IntegerField(default=0, null=False)
    score_count = models.IntegerField(default=0, null=False)
