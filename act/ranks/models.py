...
class GlobalVariables(models.Model):
    score_sd = models.FloatField(default=0.0)
    toad_bowser = models.FloatField(default=0.0)
    toad_bowser_count = models.IntegerField(default=0)
    toad_diddy = models.FloatField(default=0.0)
    toad_diddy_count = models.IntegerField(default=0)
    toad_koopa = models.FloatField(default=0.0)
    toad_koopa_count = models.IntegerField(default=0)
    toad_baby = models.FloatField(default=0.0)
    toad_baby_count = models.IntegerField(default=0)
    bowser_diddy = models.FloatField(default=0.0)
    bowser_diddy_count = models.IntegerField(default=0)
    bowser_koopa = models.FloatField(default=0.0)
    bowser_koopa_count = models.IntegerField(default=0)
    bowser_baby = models.FloatField(default=0.0)
    bowser_baby_count = models.IntegerField(default=0)
    diddy_koopa = models.FloatField(default=0.0)
    diddy_koopa_count = models.IntegerField(default=0)
    diddy_baby = models.FloatField(default=0.0)
    diddy_baby_count = models.IntegerField(default=0)
    koopa_baby = models.FloatField(default=0.0)
    koopa_baby_count = models.IntegerField(default=0)
    koopa_koopa = models.FloatField(default=0.0)
    koopa_koopa_count = models.IntegerField(default=0)
    baby_baby = models.FloatField(default=0.0)
    ...
    sum_sq = models.IntegerField(default=0)
"""
